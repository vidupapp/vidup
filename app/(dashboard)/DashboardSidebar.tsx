...
export default function DashboardSidebar({ credits }: { credits: number }) {
  ...
  return (
    <aside
      className="hidden sm:flex flex-col w-[240px] shrink-0 min-h-screen border-r border-[#F0F0F0] bg-white px-4 py-6"
    >
      {/* Logo + credit balance */}
      <div className="px-2 mb-8">
        ...
        <div className="mt-3 inline-flex items-center gap-1.5 bg-[#FFF0F0] text-[#E8192C] text-[13px] font-bold px-3 py-1.5 rounded-full">
          ⚡ {credits} credits
        </div>
      </div>
